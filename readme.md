...
*NOTE WIP - THIS POST PRETENDS THAT V8 5.9 is V8 6.0 - ASSUMPTIONS TO BE UPDATED AT NODE 8.3 RELEASE* 
...
*NOTE: benchmark for this has been updated so that length is cached, this is to avoid any string length caching behavior - graph hasn't been updated however, we'll wait till V8 6.0 update*
